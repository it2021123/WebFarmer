...
const onFormSubmit = async () => {
  ...
  const deleteEndpoint = `http://localhost:3030/api/Admin/employees/delete-employee/${userIdFromPath.value}`;

  // Use the delete function with the constructed endpoint
  useRemoteDataDELETE(deleteEndpoint, true);
  router.push({name: 'getemployees'})
};
</script>
  ...
  <div class="bg-body-tertiary">
    <div class="container">
      <div class="row py-4 px-3">
        <div class="col-4">
          <div class="mb-4">
            <h1 class="fs-3">Delete Employee</h1>
          </div>
          <div>
